...
INSERT INTO `defines` VALUES ('MY_API_AUTH_TOKEN','{{YAQDS-TOKEN}}'),('MY_API_CLIENT_ID','{{YAQDS-CLIENTID}}'),('MY_API_CLIENT_SECRET','{{YAQDS-CLIENTSCRET}}'),('MY_API_URL','https://yaqds.cc');
