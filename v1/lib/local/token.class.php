...
class Token extends Base
{
   ...
   public $jsonAccess   = null;   // JSON of access controls allowed for this token
   ...
   public function mapData($data)
   {
      ...
      $this->jsonAccess = $data['jsonaccess'];
      $this->accessList = @json_decode($data['jsonaccess'],true);
